...
# npm version for renovate
RENOVATE_CLI=${VERSION:-"latest"}
...
if [ "$RENOVATE_CLI" != "none" ]; then
	if [ "$RENOVATE_CLI" = "latest" ]; then
		util_command="renovate"
	else
		util_command="renovate@$RENOVATE_CLI"
	fi
