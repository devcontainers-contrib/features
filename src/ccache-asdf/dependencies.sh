...
featmake "ghcr.io/devcontainers-contrib/features/apt-get-packages:1.0.0" -PACKAGES "build-essential cmake" 

# refresh PATH
PS1='\s-\v\$' source /etc/profile
# installing ghcr.io/devcontainers-contrib/features/asdf-package:1.0.1
featmake "ghcr.io/devcontainers-contrib/features/asdf-package:1.0.1" -PLUGIN "ccache" -VERSION "$VERSION" 
