...
featmake "ghcr.io/devcontainers-contrib/features/pipx-package:1.1.3" -PACKAGE "glances[action,browser,cloud,cpuinfo,docker,export,folders,gpu,graph,ip,raid,snmp,web,wifi]" 
