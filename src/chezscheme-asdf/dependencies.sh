...
featmake "ghcr.io/devcontainers-contrib/features/apt-get-packages:1.0.0" -PACKAGES "build-essential uuid-dev libncurses5-dev libx11-dev" 

# refresh PATH
PS1='\s-\v\$' source /etc/profile
# installing ghcr.io/devcontainers-contrib/features/asdf-package:1.0.1
featmake "ghcr.io/devcontainers-contrib/features/asdf-package:1.0.1" -PLUGIN "chezscheme" -VERSION "$VERSION" 
