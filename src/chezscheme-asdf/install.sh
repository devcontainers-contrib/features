...
# asdf plugin version for chezscheme
CHEZSCHEME=${VERSION:-"latest"}
...
aptget_packages=(build-essential uuid-dev libncurses5-dev libx11-dev)
...
if [ "$CHEZSCHEME" != "none" ]; then
	install_via_asdf "chezscheme" "$CHEZSCHEME"
fi
