...
PACKAGES="ca-certificates" featmake "ghcr.io/devcontainers-contrib/features/apt-get-packages:1.0.0"


# installing ghcr.io/devcontainers-contrib/features/asdf-package:1.0.1
PLUGIN="raku" VERSION="$VERSION" featmake "ghcr.io/devcontainers-contrib/features/asdf-package:1.0.1"
