...
# npm version for assemblyscript
...
if [ "$ASSEMBLYSCRIPT" != "none" ]; then
	if [ "$ASSEMBLYSCRIPT" = "latest" ]; then
		npm_package="assemblyscript"
	else
		npm_package="assemblyscript@$ASSEMBLYSCRIPT"
	fi
