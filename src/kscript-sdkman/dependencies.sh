...
featmake "ghcr.io/ebaskoro/devcontainer-features/sdkman:1.0.0" -CANDIDATE "kotlin" -VERSION "$KOTLINVERSION" 

# refresh PATH
PS1='\s-\v\$' source /etc/profile
# installing ghcr.io/ebaskoro/devcontainer-features/sdkman:1.0.0
featmake "ghcr.io/ebaskoro/devcontainer-features/sdkman:1.0.0" -CANDIDATE "kscript" -VERSION "$VERSION" 
