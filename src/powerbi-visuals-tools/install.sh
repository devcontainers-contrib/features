...
# npm version for powerbi-visuals-tools
POWERBI_VISUAL_TOOLS=${VERSION:-"latest"}
...
if [ "$POWERBI_VISUAL_TOOLS" != "none" ]; then
	if [ "$POWERBI_VISUAL_TOOLS" = "latest" ]; then
		util_command="powerbi-visuals-tools"
	else
		util_command="powerbi-visuals-tools@$POWERBI_VISUAL_TOOLS"
	fi
