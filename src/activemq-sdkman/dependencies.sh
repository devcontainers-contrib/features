...
CANDIDATE="activemq" VERSION="$VERSION" featmake "ghcr.io/ebaskoro/devcontainer-features/sdkman:1.0.0"


# installing ghcr.io/devcontainers-contrib/features/bash-command:1.0.0
COMMAND="chmod +x -R /usr/local/sdkman/candidates/activemq/current/bin" featmake "ghcr.io/devcontainers-contrib/features/bash-command:1.0.0"
