...
featmake "ghcr.io/ebaskoro/devcontainer-features/sdkman:1.0.0" -CANDIDATE "activemq" -VERSION "$VERSION" 

# refresh PATH
PS1='\s-\v\$' source /etc/profile
# installing ghcr.io/devcontainers-contrib/features/bash-command:1.0.0
featmake "ghcr.io/devcontainers-contrib/features/bash-command:1.0.0" -COMMAND "chmod +x -R /usr/local/sdkman/candidates/activemq/current/bin" 
